...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    text = (
        ...
        "📋 Правила ведения реестра КТП (казахстанское содержание), Приказ от 2025 № 327\n"
        "📋 Единая методика расчёта ДВЦ при закупке товаров, работ и услуг, Приказ от 2018 № 260\n"
        "📋 Правила организации питания в государственных организациях образования, Приказ МОН РК от 31.10.2018 № 598\n\n"
        "Примеры вопросов:\n"
